...
public class UnityInput : MonoBehaviour
{
     ...
     * 유니티 입력
     * 
     * 유니티에서 사용자으 명령을 감지할 수 있는 수단
     * 사용자는 외부장치를 이용하여 게임을 제어할 수 있음
     * 유니티는 다양한 타입의 입려기기(키보드 및 마우스, 조이스틱, 터치스크린 등 )을 지원
     * ***************************/
    private void Update()
    {
        InputByDevice();
    ...
    // 입력 매니저의 이름으로 정의한 입력의 변경사항을 확인
    // 유니티 에디터의 Edit -> Project Settings -> Input Manager 에서 관리
    private void InputByInputManager()
    {
        //버튼입력
        //Fire1 : 키보드 (Left ctr1), 마우스 (Left Button), 조이스틱(button 0) 으로 정의
